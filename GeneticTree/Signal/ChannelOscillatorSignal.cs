...
namespace GeneticTree.Signal
    ...
    ///     This class keeps track of an oscillator respect to its thresholds and updates an <see cref="ChannelOscillatorSignal" />
        ...
        ///     Initializes a new instance of the <see cref="ChannelOscillatorSignal" /> class.
            ...
            public ChannelOscillatorSignal(IndicatorBase<IndicatorDataPoint> price, IndicatorBase<IndicatorDataPoint> max, IndicatorBase<IndicatorDataPoint> min, Direction direction, int survivalPeriod) : base(price, direction, survivalPeriod)
            {
